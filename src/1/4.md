# Vue 源码 [331](https://www.processon.com/mindmap/63ac109f6592974cd49ff115) 源码 -> 文件步骤 -> 路径复制 -> 文件复制 -> 调试
...
### 5.2 初始化.[xx](../../public/example/1.vue3.base/xx)

```js

```

### 5.3 初始化.[xx](../../public/example/1.vue3.base/xx)

```js

```

### 5.4 初始化.[xx](../../public/example/1.vue3.base/xx)

```js

```

### 5.5 初始化.[xx](../../public/example/1.vue3.base/xx)
