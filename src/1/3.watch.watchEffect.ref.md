...
### 4.2 [public/example/2.vue.core/example/2.proxy.html](../../public/example/2.vue.core/example/2.proxy.html)

```html
<script type="module">
  import { reactive } from '/packages/vue/dist/vue.runtime.esm-bundler.js'
